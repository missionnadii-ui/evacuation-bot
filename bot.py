...
async def ev_ok(u, c):
    if '✅' in u.message.text:
        ...
        await u.message.reply_text(f"✅ *Збережено!* Всього: {len(c.bot_data['evacuees'])} осіб", parse_mode='Markdown', reply_markup=menu_kb())
    else:
...
def main():
    ...
    logger.info("🕊️ Місія Подих Надії Bot started!")
